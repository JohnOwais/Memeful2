...
public class MostViralFragment extends Fragment {
    ...
    private void render() {
        RecyclerView rv = view.findViewById(R.id.rv_of_photos);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_most_viral, null);
        recyclerView = view.findViewById(R.id.rv_of_photos);
    ...
    public void getData(int pageNo) {
        Request request = new Request.Builder()
                .url("https://api.imgur.com/3/gallery/hot/viral/" + pageNo + ".json")
                .method("GET", null)
        ...
        httpClient.newCall(request).enqueue(new Callback() {
            ...
            public void uploadImageData(String uID, String photoID, String id, String title, String userName, String views, String ups, String downs, String favCount) {
                databaseHelper.storeImageData(uID, photoID, id, title, userName, views, ups, downs, favCount, 1);
            }
        });
    }
}